...
namespace DAL
{
    public class UserDAL : BaseDAL, IUserDAL
    {
        ...
        public bool Login(User user)
        {
            ...
            SqlParameter[] Params = new SqlParameter[]{
                new SqlParameter("@password",user.Password),
                new SqlParameter("@username",user.LoginName)
            };

            sb.Append("select count(*) from [SOI_Users] where LoginName=@username and password=@password and isvalid=1");
        ...
        public bool ExistName(string username)
        {
            ...
            sb.Append("select count(*) from [SOI_Users] where username=@username and isvalid=1");
